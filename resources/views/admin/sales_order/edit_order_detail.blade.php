    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                @endif
                <form action="admin/sales_order/edit_detail_order/{{$sales_order_item->id}}" method="POST">
                    <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                    <div class="form-group">
                        <label>Mã đơn hàng</label>
                        <input class="form-control" name="order_id" value="{{$sales_order_item->sales_order_id}}" />
                    </div>
                    <div class="form-group">
                        <label>Mã sản phẩm</label>
                        <input class="form-control" name="laptop_id" value="{{$sales_order_item->product_id}}" />
                    </div>
                    <div class="form-group">
                        <label>Giá</label>
